            ...
            <div className="container mx-auto px-6 max-w-7xl relative z-10">
                <div className="text-center mb-32">
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        className="inline-flex items-center gap-3 px-5 py-2 rounded-full bg-white/5 border border-white/10 text-primary-purple text-[11px] font-black uppercase tracking-[0.4em] mb-10"
                    >
                    ...
                    >
                        Interactive 3D plots, thermal contours, and predictive diagnostics.
                        Engineered for clarity, ready for submission.
                    </motion.p>
                </div>
