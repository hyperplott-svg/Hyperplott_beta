            ...
            <div className="container mx-auto px-6 max-w-7xl relative z-10">
                <div className="text-center mb-24">
                    ...
                    >
                        ...
                        <span className="text-emerald-500">For Researchers</span>.
                    </motion.h2>
                </div>

                <div className="grid md:grid-cols-2 gap-8 mb-24 max-w-6xl mx-auto">
                    {/* Founder 1 */}
                    <div className="group p-px rounded-[3rem] bg-gradient-to-br from-emerald-500/20 via-transparent to-transparent">
                        <div className="bg-slate-950 p-10 rounded-[2.9rem] h-full flex flex-col items-center text-center">
                            <div className="w-32 h-32 rounded-[2rem] bg-emerald-500/10 border border-emerald-500/20 overflow-hidden mb-6 shadow-glow relative">
                            ...
                            <a href="https://www.linkedin.com/in/madduluri-shiva-kailash-355166281/" target="_blank" rel="noreferrer" className="text-emerald-500 font-black uppercase tracking-[0.3em] text-[10px] mb-6 hover:underline">Founder</a>
                    ...
                    {/* Founder 2 */}
                    <div className="group p-px rounded-[3rem] bg-gradient-to-br from-teal-500/20 via-transparent to-transparent">
                        <div className="bg-slate-950 p-10 rounded-[2.9rem] h-full flex flex-col items-center text-center">
                            <div className="w-32 h-32 rounded-[2rem] bg-teal-500/10 border border-teal-500/20 overflow-hidden mb-6 shadow-glow relative">
                            ...
                            <a href="https://www.linkedin.com/in/jmadhan/" target="_blank" rel="noreferrer" className="text-emerald-500 font-black uppercase tracking-[0.3em] text-[10px] mb-6 hover:underline">Co-Founder</a>
                            <p className="text-text-secondary text-base leading-relaxed opacity-70 font-medium">
