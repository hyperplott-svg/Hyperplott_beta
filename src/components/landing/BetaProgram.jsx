                ...
                <div className="rounded-[3rem] bg-gradient-to-br from-primary-purple to-primary p-12 md:p-20 text-center text-white shadow-2xl relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                        ...
                        <div className="flex flex-col items-center gap-6">
                            <Link to="/login" className="px-12 py-5 rounded-2xl bg-white text-primary-purple text-xl font-black uppercase tracking-widest hover:scale-105 transition-transform shadow-xl">
                                Join Beta Now
                            </Link>
