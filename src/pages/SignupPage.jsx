    ...
    return (
        <>
            ...
            <div className="min-h-screen grid lg:grid-cols-2 bg-slate-950 overflow-hidden font-sans">
                ...
                <div className="hidden lg:flex flex-col justify-between p-16 relative bg-slate-950 overflow-hidden border-r border-white/5">
                    ...
                    <div className="relative z-10 flex-1 flex flex-col justify-center">
                        <motion.div
                            ...
                            className="mb-12 aspect-square max-w-[340px] mx-auto bg-white/[0.02] rounded-[3rem] backdrop-blur-xl border border-white/5 p-6 shadow-2xl"
                        >
                            <RotatingDesign />
                        </motion.div>
                        ...
                        <div className="max-w-md mx-auto space-y-8">
                            <h2 className="text-4xl font-black text-white leading-tight tracking-tighter">
                                Join the next generation of <br /><span className="text-emerald-500">Scientific Research.</span>
                            </h2>

                            <div className="space-y-4">
                                {[
                                    { icon: CheckCircle2, text: 'Unlimited AI-optimized experimental matrices', color: 'text-emerald-500' },
                                    { icon: Zap, text: 'Full statistical analysis & ANOVA engines', color: 'text-emerald-500' },
                                    { icon: Globe, text: 'Secure cloud vault for clinical collaboration', color: 'text-emerald-500' }
                                ].map((item, i) => (
                                    <motion.div
                                        ...
                                        key={i}
                                        className="flex items-center gap-4 text-slate-400 font-semibold"
                                    >
                                        <div className="w-10 h-10 rounded-xl bg-white/5 flex items-center justify-center text-emerald-500 shadow-sm border border-white/5">
                ...
                <div className="flex items-center justify-center p-8 lg:p-20 bg-slate-950 relative overflow-y-auto">
                    {/* Back to Home Button */}
                    <Link
                        to="/"
                    ...
                    {/* Decorative blobs */}
                    <div className="absolute top-0 left-0 w-96 h-96 bg-emerald-500/5 rounded-full blur-[120px] -z-10" />
                    <div className="w-full max-w-xl">
                        ...
                        >
                            ...
                            <p className="text-slate-500 font-medium">Initialize your professional scientific workspace.</p>
                        </motion.div>
                        ...
                        >
                            <div className="p-1">
                                <form className="space-y-6" onSubmit={(e) => { e.preventDefault(); navigate('/dashboard'); }}>
                                    <div className="grid md:grid-cols-2 gap-6">
                                        <div className="space-y-3">
                                            ...
                                            <div className="relative group">
                                                <User className="absolute left-5 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-500 group-focus-within:text-emerald-500 transition-colors" />
                                                <input
                                                    type="text"
                                                    value={name}
                                        ...
                                        <div className="space-y-3">
                                            ...
                                            <div className="relative group">
                                                <Building2 className="absolute left-5 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-500 group-focus-within:text-emerald-500 transition-colors" />
                                                <input
                                                    type="text"
                                                    value={institution}
                                    ...
                                    <div className="space-y-3">
                                        <label className="text-[10px] font-black text-slate-500 uppercase tracking-widest ml-1">Registry Email</label>
                                        <div className="relative group">
                                    ...
                                    <div className="p-6 bg-white/[0.02] rounded-2xl border border-white/5 flex gap-4">
                                        <div className="w-12 h-12 rounded-xl bg-emerald-500/10 flex items-center justify-center text-emerald-500 shrink-0 border border-emerald-500/20">
                                            <ShieldCheck className="w-6 h-6" />
                                        </div>
                                        <p className="text-[10px] text-slate-500 font-medium leading-relaxed">
                                            By clicking "Initialize Registry", you agree to our <a href="#" className="font-bold text-white hover:underline">Sentinel Protocol</a> and <a href="#" className="font-bold text-white hover:underline">Data Policy</a>. All experimental outcomes remain institutional property.
                                        </p>
                                    </div>
                            ...
                            <div className="mt-8 text-center pb-8">
                                <p className="text-[11px] font-black uppercase tracking-widest text-slate-500">
                                    Already registered? <Link to="/login" className="text-emerald-500 hover:underline px-1">Sign In</Link>
                                </p>
                            </div>
                        </motion.div>
                    </div>
